  ...
  return (
    <>
      <button onClick={() => setOpen(true)} aria-label="Search"
        className="tblabel flex items-center gap-2 rounded-md border border-line px-2.5 py-3 text-ink-dim transition hover:border-line-strong hover:text-ink md:py-1.5">
